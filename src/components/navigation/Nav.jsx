    ...
    <nav className='navigation'>
      <ul className='navigation__list'>
        <li className='navigation__list_items'>
          <Link title='Home' className='navigation__list_items-links navigation__list_items-links--1 nav_active_page' to="/">
        ...
        <li className='navigation__list_items'>
          <Link title='About' className='navigation__list_items-links navigation__list_items-links--2' to="/about">
        ...
        <li className='navigation__list_items'>
          <Link title='Projects' className='navigation__list_items-links navigation__list_items-links--3' to="/projects">
        ...
        <li className='navigation__list_items'>
          <Link title='Contact' className='navigation__list_items-links navigation__list_items-links--4' to="/contact">
