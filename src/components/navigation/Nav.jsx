    ...
    <nav className='navigation'>
      <ul className='navigation__list'>
        <li className='navigation__list_items'>
          <Link
            title='Home'
            className={`navigation__list_items-links navigation__list_items-links--1 ${activeLink === 'dewan.dev/' ? 'nav_active_page' : ''}`}
            to="dewan.dev/"
        ...
        <li className='navigation__list_items'>
          <Link
            title='About'
            className={`navigation__list_items-links navigation__list_items-links--2 ${activeLink === 'dewan.dev/about' ? 'nav_active_page' : ''}`}
            to="dewan.dev/about"
        ...
        <li className='navigation__list_items'>
          <Link
            title='Projects'
            className={`navigation__list_items-links navigation__list_items-links--3 ${activeLink === 'dewan.dev/projects' ? 'nav_active_page' : ''}`}
            to="dewan.dev/projects"
        ...
        <li className='navigation__list_items'>
          <Link
            title='Contacts'
            className={`navigation__list_items-links navigation__list_items-links--4 ${activeLink === 'dewan.dev/contacts' ? 'nav_active_page' : ''}`}
            to="dewan.dev/contacts"
