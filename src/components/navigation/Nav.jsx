    ...
    <nav className='navigation'>
      <ul className='navigation__list'>
        <li className='navigation__list_items'>
          <a className='navigation__list_items-links navigation__list_items-links--1 nav_active_page' href="/">
        ...
        <li className='navigation__list_items'>
          <a className='navigation__list_items-links navigation__list_items-links--2' href="/about">
        ...
        <li className='navigation__list_items'>
          <a className='navigation__list_items-links navigation__list_items-links--3' href="/projects">
        ...
        <li className='navigation__list_items'>
          <a className='navigation__list_items-links navigation__list_items-links--4' href="/contact">
