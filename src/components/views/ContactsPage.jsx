                ...
                <div className="contactsPage__containerOne_content">
                    ...
                    <div className="contactsPage__containerOne_content-linksBox">
                        ...
                        <div className="contactsPage__containerOne_content-linksBox--socialsBox">
                            <a href="mailto:zmn.tasin@gmail.com" className="contactsPage__containerOne_content-linksBox--socialsBox---link linkedin_hoverClass" title='Email'>
                            ...
                            <a href="mailto:zmn.tasin@gmail.com" className="contactsPage__containerOne_content-linksBox--socialsBox---link instagram_hoverClass" title='Email'>
                            ...
                            <a href="mailto:zmn.tasin@gmail.com" className="contactsPage__containerOne_content-linksBox--socialsBox---link facebook_hoverClass" title='Email'>
                            ...
                            <a href="mailto:zmn.tasin@gmail.com" className="contactsPage__containerOne_content-linksBox--socialsBox---link dribble_hoverClass" title='Email'>
